...
class Alimento():
    ...
    def __init__(self,nombre,preparacion,estado,image,size,localizacion):
        self.nombre=nombre
...
class Proteina(Alimento):
    def __init__(self,nombre,preparacion,estado,image,rectangulo,localizacion):
        super().__init__(nombre,preparacion,estado,image,rectangulo,localizacion)
...
class Juego():
    ...
    def crear_jugador(self):
        self.uno_alpha=Jugador_alpha('uno.png',(60,60),(700,310),[])
        self.dos_alpha=Jugador_alpha('uno.png',(60,60),(100,310),[])
        self.uno_betha=Jugador_betha('dos.png',(60,60),(500,310),[])
        self.dos_betha=Jugador_betha('dos.png',(60,60),(670,45),[])
