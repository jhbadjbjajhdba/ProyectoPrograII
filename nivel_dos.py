...
class Juego():
    ...
    def crear_jugador(self):
        self.uno_alpha=Jugador_alpha('uno_dos.png',(60,60),(700,310),[])
        self.dos_alpha=Jugador_alpha('uno_dos.png',(60,60),(100,310),[])
...
#_______________________________________________________________________________________________________________________________________
                if event.key == pygame.K_f:
                    ...
                    for f in self.lista_hornos:
                        if len(self.jugador_escogido.inventario)==1 and len(f.bandeja)==0:
                            if self.jugador_escogido.rectangulo.colliderect(f.rectangulo):
                                if self.jugador_escogido.inventario[0].get_estado()==('Semilisto') and self.jugador_escogido.inventario[0].get_grupo_alimentario()==('pure'):
